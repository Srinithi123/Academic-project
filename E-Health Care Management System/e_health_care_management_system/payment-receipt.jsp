          ...
          <tbody>
			...
			%>
				<tr>
				  ...
				  <td>
				  <a href="doctor-details.jsp?doctor_id=<% out.print(OrderDetails.get("oi_doctor_id")); %>">
					<img src="doctorImages/<% out.print(OrderDetails.get("doctor_image")); %>" style="height:80px; width:80px;">
				  </a> <br>
				  <% out.print(OrderDetails.get("doctor_name")); %>
				  </td>
