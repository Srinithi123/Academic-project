...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      ...
      <h2>Make Payment</h2>
        <form action="appointment-details.jsp?appointment_id=<% out.print(request.getParameter("appointment_id")); %>" method="post" id="Form">
          <div>
          ...
          <div>
            ...
            <input type="text" name="sal_amount" id="sal_amount" size="22" style="width:300px;" value="<% out.print(Values.get("doctor_fees")); %>" readonly>
          </div>
