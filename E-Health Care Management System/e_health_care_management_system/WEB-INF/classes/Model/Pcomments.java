...
public class Pcomments extends Connect
{
	...
	{
		String SQL = "INSERT INTO `pcomments` (`pcomment_doctor_id`, `pcomment_name`, `pcomment_email`, `pcomment_description`) VALUES (?, ?, ?, ?);";
		int record=0; 
		String error = "";
		...
		try
		{
			...
			pstmt.setString(1,(String) ticketData.get("pcomment_doctor_id"));
    ...
    public ArrayList getAllPcomments(String doctor_id)
	{
		String SQL = "SELECT * FROM `pcomments` WHERE pcomment_doctor_id = "+doctor_id+" ORDER BY pcomment_id ASC";
		int count=0;
